...
local no_errors, error_msg = pcall(function()
    ...
    _G.packer_plugins = {
        ...
        ["gruvbox-baby.git"] = {
            loaded = true,
            path = "/home/kishan/.local/share/nvim/site/pack/packer/start/gruvbox-baby.git",
        ...
        notification = {
            loaded = true,
            path = "/home/kishan/.local/share/nvim/site/pack/packer/start/notification",
            url = "/home/kishan/Personal/Projects/notification"
        },
        ["nvim-dap-go.git"] = {
            loaded = true,
        ...
        ["tokyonight.nvim.git"] = {
            loaded = true,
            path = "/home/kishan/.local/share/nvim/site/pack/packer/start/tokyonight.nvim.git",
